...
* Following safety protocols when working with hardware
...
* Sharing proprietary theatrical designs without authorization
* Ignoring safety warnings or encouraging unsafe practices
...
This Code of Conduct applies within all community spaces, and also applies when an individual is officially representing the community in public spaces. Examples include using an official e-mail address, posting via official social media accounts, or acting as a representative at events.
...
Given the nature of this project involving mechanical actuators and electrical systems:

* **Always prioritize safety** in discussions and code contributions
* **Never disable or bypass** safety features
* **Report safety concerns** immediately to maintainers
* **Test thoroughly** before deploying to production environments
* **Follow theatrical safety standards** and local regulations

Remember: We're building tools for entertainment that must be safe for performers, technicians, and audiences.